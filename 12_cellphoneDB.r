...
cellphonedb method statistical_analysis meta_Polyp.txt count_Polyp.txt --database cellphone.db --counts-data=gene_name --output-path ./out
cellphonedb method statistical_analysis meta_Unaffected.txt count_Unaffected.txt --database cellphone.db --counts-data=gene_name --output-path ./out
cellphonedb method statistical_analysis meta_Cancer.txt count_Cancer.txt --database cellphone.db --counts-data=gene_name --output-path ./out
